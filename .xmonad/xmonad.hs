...
main = do
    --xrandr
    spawnPipe "xrandr --output DP-2 --primary --mode 1920x1080 --left-of VGA-1"
    spawnPipe "xrandr --output VGA-1 --rotate left"
    ...
    xmonad $ ewmh def
        ...
        , logHook = dynamicLogWithPP $ namedScratchpadFilterOutWorkspacePP $ xmobarPP
              ...
              , ppHidden = xmobarColor "#8be9fd" "" . wrap "<box type=Top width=2 mt=2 color=#8be9fd>" "</box>" . clickable -- Hidden workspaces
              , ppHiddenNoWindows = xmobarColor "#8be9fd" ""  . clickable     -- Hidden workspaces (no windows)
